...
interface TypeValidatorInterface
{
     ...
     * @param string $typeGroup            Collection of types in string format i.e. oneof(...), anyof(...)
     ...
     */
    public function verifyTypes($value, string $typeGroup, array $serializationMethods = []);
}
